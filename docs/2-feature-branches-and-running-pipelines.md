...
1. Sign into the LUIS *preview* portal for [your authoring and publishing region](https://docs.microsoft.com/azure/cognitive-services/luis/luis-reference-regions):
...
1. Select your Azure Subscription and your LUIS Authoring resource.
